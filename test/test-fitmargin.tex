...
\verb|\proplevelchoice|, the second entry being a self-assignment.
...
self-assignment must still read a sane value there, not whatever the enclosing
list left behind --- which under \verb|outerfit| would be the outer item's
fitted width.
