...
\verb|fitmargin| measures \verb|\propwidest{\propformlabel}|, not \verb|\propformlabel|, so
...
\verb|\__props_widest:n| of \textbf{(3.147)} is \widen{\textbf{(3.147)}}, which
must still be bold, and of \textsc{Prop}~1a is \widen{\textsc{Prop}~1a},
