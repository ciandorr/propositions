...
%% \propwidest with proportional (oldstyle) figures.  Computer Modern cannot
...
\verb|\propwidest| of \textbf{(3.147)} is \propwidest{\textbf{(3.147)}}, still
bold and with the point still in place; of \textsc{Prop}~1a it is
\propwidest{\textsc{Prop}~1a}, still small caps with the space intact; and of a
label with no digits at all, \emph{Nihilism}, it is \propwidest{\emph{Nihilism}}
