...
\begin{prop}
  \pitem[style=thesis, Physicalism] Everything is physical. \label{phys}
  \pitem[style=thesis, Dualism] Mind and body are distinct. \label{dual}
\end{prop}
...
\begin{prop}
    \pitem[style=thesis, name={Problems with \ref{myP3}}]
...
\begin{prop}
  ...
  \pitem[style=thesis, Thesis] A long-format item. \label{thesis}
\end{prop}
...
\begin{prop}
  \pitem[A] First premise. \label{dlevel:pitemA}
  \begin{equation}
    E = mc^2 \ptag[Named] \label{dlevel:named}
  \end{equation}
  \pitem[B] Second premise. \label{dlevel:pitemB}
\end{prop}

% \ptag has an explicit argument, so it uses the default type regardless of
% level.  Ref should be \textbf{Named} (same as a plain default-type pitem).
...
\begin{prop}
  \pitem First item. \label{dlevel:outer}
  \begin{equation}
...
\begin{prop}
  \pitem Premise. \label{dlevel:align_outer}
  \begin{align}
...
\begin{prop}
  \pitem First. \label{dlevel:before}
  \begin{equation}
    a = b \ptag \label{dlevel:inside}
  \end{equation}
  \pitem After equation: level should be restored to 1 (numbered type). \label{dlevel:after}
\end{prop}
...
\begin{prop}
  \pitem[Identity Theory, format={the #1}]
